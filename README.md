...
- [Suzuki-Trotter-Evolver](https://github.com/Christopher-K-Long/Suzuki-Trotter-Evolver) (== 1.1.2, packaged with PySTE)
- [Eigen3](https://eigen.tuxfamily.org/) (>=3.6, <6, packaged with PySTE)
...
The current version is [`1.1.2`](ChangeLog.md#release-112). Please see the [Change Log](ChangeLog.md) for more details. PySTE uses [semantic versioning](https://semver.org/).
